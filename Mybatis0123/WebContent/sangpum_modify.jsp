...
<body>
	...
	<section id="articleForm">
		...
		<form action="sang.do?command=modify" method="post">
			...
			<input type="submit" value="수정" style="font-size: 15px;"> <input type="button" value="취소"  style="font-size: 15px; margin-top: 14px;" onClick="script: location.href='index.html'">
