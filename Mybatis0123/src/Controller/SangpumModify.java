...
public class SangpumModify implements CommandInter{
	static SangpumModify impl = new SangpumModify();
	public static SangpumModify instance() { //instance 메소드가 늘 객체를 리턴하는 것 이것이 싱글톤 패턴 !  static 이 붙어있으므로 한번 만들어 놓으면 계속해서 쓸 수 있으므로 중복이 안되지만 
		return impl;
}
	@Override
