				...
				<div id="matList">
					...
					<div class="cbox">
						<table class="table table-striped" id="qnaTopTable">
							<tbody>
								<tr>
									<td style="text-align:center; font-size:18px;">제목</td>
									<td>
								...
								<tr>
									<td style="text-align:center; font-size:18px;">작성자</td>
									<td>
										<div class="form-group has-success">
											<%=one.getqMember() %>
										</div>
								...
								<tr style="height:300px;">
									<td style="text-align:center; font-size:18px;">내용</td>
									<td>
										<%=one.getqContents() %>
						...
						<input class="btn btn-default" type="button" value="목 록" style=" margin-left: 10px;" onclick="script: location.href='qna.jsp'">
						<input class="btn btn-default" type="button" value="수 정" style=" margin-left: 10px;" onclick="script: location.href='qnaupdate.jsp?qNo='+'<%=one.getqNo()%>'+'&qTitle='+'<%=one.getqTitle()%>'+'&qMember='+'<%=one.getqMember()%>'+'&qContents='+'<%=one.getqContents() %>';">
						<input class="btn btn-default" type="button" value="삭 제" style=" margin-left: 10px;" onclick="script: location.href='qnadelete.jsp?qSecretNum='+'<%=one.getqSecretNum()%>'+'&qNo='+<%=one.getqNo() %>;">
