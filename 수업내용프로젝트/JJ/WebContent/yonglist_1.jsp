					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td class="thdate2"  style=" text-align:center;"><a onClick="window.open('YonglistUsebean.jsp?index=<%=yong.get(i).getyNo()%>&id=<%=yid%>','newwindow','width=1000,height=800,location=no,status=no,scrollbar=yes');" class="button">
