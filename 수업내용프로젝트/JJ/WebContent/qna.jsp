		...
		<section id="main">
			<section id="mainright">
				<div id="matList">
					<div class="sec_ban2">
						<ul class="nav_ban">
							<li><img src="img/qna.jpg" style="width: 100%; height: 230px"></li>
						</ul>
					</div>
					<div class="cbox">
						<table class="table table-striped" id="qnaTopTable">
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="form-group has-warning" style="height: 45px">
											...
											<input type="password" class="form-control" id="qSecretNum" name="qSecretNum" maxlength="10" style="width: 250px">
										</div>
									</td>
								</tr>
								...
								<tr>
									<td>내용</td>
									<td><textarea class="form-control" rows="7" style="resize: none;" id="qContents" name="qContents">
										</textarea></td>
								</tr>
							</tbody>
						</table>
						<input type=submit class="btn btn-default pull-right" id="write" name="write" value="글쓰기"><br> <br> <br> <br> <br> <br>
						<table class="table table-striped">
							...
							<tbody>
								...
								%>
								<tr>
									<td class="thno"><%=list.get(i).getqNo()%></td>
									<td class="thtitle">
										<center>
											<a onClick="selectOne(<%=list.get(i).getqNo() %>); " class="button" id="listtt"><%=list.get(i).getqTitle() %></a><img src="img/lock2.png" class="secretimg">
										</center>
									</td>
									<td class="thname"><%=list.get(i).getqMember()%></td>
						...
						<select class="form-control" style="width: 200px; float: left; margin-left: 150px;">
							<option>전체기간
						</select> <select class="form-control" style="width: 200px; float: left; margin-left: 10px;">
							<option>제목+내용
						</select> <input type="text" class="form-control" id="exampleInputEmail1" placeholder="검색어를 입력하세요" class="form-control" style="width: 300px; float: left; margin-left: 10px;"> <input class="btn btn-default" type="button" value="검 색" style="float: left; margin-left: 10px;">
					</div>
			</section>
		</section>
