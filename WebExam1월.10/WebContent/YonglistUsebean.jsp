...
<script>
	function del() {
		...
		if (con_test == true) {
			...
			document.write("취소를 누르셨군요.창을 닫아주세요.");
...
<body>
 ...
 %>
		...
		<input class="signbutton signbutton5" type="button" value="용병수정"
			style="font-size: 18px; width: 140px; float: left; margin: 50px 150px;"
			onClick="location.href='yongedit.jsp?index=<%=index%>&id=<%=yid%>'" />
		<input class="signbutton signbutton5" type="button" value="용병삭제"
