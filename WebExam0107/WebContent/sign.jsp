...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#name").blur(function(){
			if(join.pw.value.length!=0)
				callAjax();
			else{
				$("#ajaxReturn").html("비밀번호를 확인하세요. 4~14자 사이의 비밀번호만 유효합니다");
			}
		});
		$("#pwch").blur(function(){
					...
					<div class="container" id="formInnerWrapper">
						<form name="join" id="materialForm" class="form" method="post" action="signInsert.jsp" role="form" autocomplete="off">
							<div class="form-group">
								...
								<div class="col-xs-2">
									<input type="button" value="중복확인" id="idcheck" name="idcheck" class="btn btn-default">
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									<label class="labels" for="pw">비밀번호<img src="//img.echosting.cafe24.com/skin/base/common/ico_required.gif" alt="필수"></label> <input type="password" class="formInput" id="pw" name="pw">
								</div>
								<div class="col-xs-4">
									<label class="labels" for="pwch">비밀번호재확인<img src="//img.echosting.cafe24.com/skin/base/common/ico_required.gif" alt="필수"></label> <input type="password" class="formInput" id="pwch" name="pwch">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<label class="labels" for="hp2"></label> <input type="text" class="formInput" id="hp2" name="hp2">
								</div>
								<div style="float: left;">-</div>
								<div class="col-xs-2">
