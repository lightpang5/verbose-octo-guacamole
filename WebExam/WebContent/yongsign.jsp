		...
		<section id="mainright">
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					<center>
					<div class="writeboardtitle" style="text-align: center; font-size: 50px;">용병 등록</div>

					</center>
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post" action="yongsignInsert.jsp?fn=1&yid=<%=uss%>" role="form" autocomplete="off">
