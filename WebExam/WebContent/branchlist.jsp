...
<img src=<%if (convenarr[5].contains("o")) {%> "img/shoes_o.png"<%} else if (convenarr[5].contains("x")) {%>"img/shoes_x.png"<%}%> alt="풋살화대여" class="branchdetailicon" />
							...
							<tr>
								<td><input type="button" value="예약하기" class="signbutton signbutton5" style="float: left; margin-left: 250px;" onclick="script: location.href='reservation.jsp'"> <input type="button" value="지점소개" onclick="script: location.href='branchlist.do?command=branchdetail&branch_no=<%=BranchList.get(i).getBranch_no()%>'" class="signbutton2 signbutton2_5" style="float: left;"></td>
							</tr>
						</tbody>
