					...
					<table>
						<tbody>
							<tr>
								...
								<td style="color: #1b4367; width: 675px; height: 80px; font-weight: bold; font-size: 30px; padding-left: 20px;">지점이름
									<hr style="width: 720px; border-top: 2.3px solid #254765;">
								</td>
							<tr>
								<td style="padding-left: 20px; font-size: 17px;"><img src="img/iconlocation.png" style="padding-right: 12px;">서울시 강동구 아리수로 97길 20</td>
							</tr>
							<tr>
								<td style="padding-left: 20px; font-size: 17px; letter-spacing: 2px;"><img src="img/iconphone.png" style="padding-right: 12px;">02-789-1234</td>
							</tr>
							<tr>
								<td><input type="button" value="예약하기" class="signbutton signbutton5" style="float: left; margin-left: 200px;" onclick="script: location.href='reservation.jsp'"> <input type="button" value="지점소개" class="signbutton2 signbutton2_5" style="float: left;"></td>
							</tr>
						</tbody>
					</table>
					<hr>
