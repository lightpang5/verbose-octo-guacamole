...
<body>
	...
	<section id="main">
		<section id="mainright">
			<div id="matList">
				<h3
					class="h_tit" style="font-weight:normal;">용
					병 등 록 </h3>
				<div class="cbox">
					<table class="table table-striped" style="font-size: 16px;">
						...
						<tbody>
							<input class="signbutton signbutton6" type="button" value="용병등록"
								style="float: right; margin: 10px;"
								onClick="location.href='yongsign.jsp'">

							<%
								ArrayList<vo.YonglistDto> yong = yl.select();
							...
							<tr>
								<td class="thgongji"><%=yong.get(i).getY_b_branch()%></td>

								<td class="thdate2" style="text-align: center;"><a
									onClick="selectOne(<%=yong.get(i).getYno()%>,'<%=yong.get(i).getYid()%>'); "
									class="button" id="listtt"> <%=yong.get(i).getY_b_schedule()%></a></td>

								<td class="thdate2" style="text-align: center;"><%=yong.get(i).getY_b_time()%></td>

								<td class="thname"><%=yong.get(i).getY_b_name()%></td>


								<td class="thview"><%=yong.get(i).getY_b_status()%></td>
							</tr>
					...
					<select class="form-control"
						style="width: 200px; float: left; margin-left: 150px;">
						<option>전체기간
