...
public class BoardReplyProAction implements Action {
	 ...
	 throws Exception{
		    ...
		    String nowPage = request.getParameter("page");
		 	...
		 	article.setGB_NUM(Integer.parseInt(request.getParameter("BOARD_NUM")));
		 	//article.setBOARD_NAME(request.getParameter("BOARD_NAME"));
		 //	article.setBOARD_PASS(request.getParameter("BOARD_PASS"));
		 	article.setGB_SUBJECT(request.getParameter("BOARD_SUBJECT"));
		 	article.setGB_CONTENTS(request.getParameter("BOARD_CONTENT"));
