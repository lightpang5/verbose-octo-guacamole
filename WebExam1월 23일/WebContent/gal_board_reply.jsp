			...
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					...
					<div class="container" id="formInnerWrapper">
						<form action="galReplyPro.bo" method="post" name="boardform">


							<input type="hidden" name="page" value="<%=nowPage%>" /> <input type="hidden" name="GB_NUM" value="<%=article.getGB_NUM()%>"> <input type="hidden" name="GB_RE_REF" value="<%=article.getGB_RE_REF()%>"> <input type="hidden" name="GB_RE_LEV" value="<%=article.getGB_RE_LEV()%>"> <input type="hidden" name="GB_RE_SEQ" value="<%=article.getGB_RE_SEQ()%>">


							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-8">
									<label class="labels" for="GB_SUBJECT">제목</label> <input type="text" class="formInput" id="GB_SUBJECT" name="GB_SUBJECT" style="font-size: 18px;">
								</div>
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-8">
									<label class="labels" for="GB_ID">글쓴이</label> <input type="text" class="formInput" id="GB_ID" name="GB_ID" style="font-size: 18px;">
								</div>
							...
							<div class="form-group" style="height: 550px;">
								<div class="col-xs-2"></div>
								<div class="col-xs-8">
									<label class="labels" for="GB_CONTENT"></label>
									<textarea name="GB_CONTENT" id="GB_CONTENT" style="width: 730px; resize: none; height: 470px;" placeholder="내용을 입력하세요."></textarea>
								</div>
