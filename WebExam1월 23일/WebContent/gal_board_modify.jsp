					...
					<div class="container" id="formInnerWrapper">
						<form action="galModifyPro.bo" method="post" name="modifyform">
							...
							<div class="form-group margin4">
								...
								<div class="col-xs-8">
									<label class="labels active" style="font-size: 16px; letter-spacing: normal;">제목</label> <input type="text" class="formInput" id="GB_SUBJECT" name="GB_SUBJECT" style="letter-spacing: normal; font-size: 14px;" value="<%=article.getGB_SUBJECT()%>">
								</div>
							...
							<div class="form-group formtotalsize">
								...
								<div class="col-xs-8">
									...
									<textarea name="GB_CONTENTS" id="GB_CONTENTS" class="contentbox"><%=article.getGB_CONTENTS()%></textarea>
								</div>
