		...
		<div id="navtop">
			...
			<div id="navtop_menu">
				<ul class="menu">
					...
					<li class="borderRightLeft"><a href="gal.bo">팀커뮤니티</a>
						<ul>
				...
				<div id="container" style="float: left;">
					...
					<fieldset id="signin_menu">
						<form name="login" method="post" id="signin" action="login.jsp">
							...
							<p class="remember">
								<input id="signin_submit" value="로그인" tabindex="6" type="submit"> <input id="remember" name="remember_me" value="1" tabindex="7" type="checkbox"> <label for="remember" style="font-size: 13px;">로그인상태유지</label>
							</p>
							<p>
