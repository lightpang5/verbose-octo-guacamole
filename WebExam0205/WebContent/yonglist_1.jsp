			...
			<h3 style="margin-bottom: 30px;
				...
				<div class="cbox">
					<table class="table table-striped" style="font-size: 16px;">
						...
						<tbody>
							<input class="signbutton signbutton6" type="button" value="용병등록" style="float: right; margin: 10px;" onClick="location.href='yongsign.jsp'">
