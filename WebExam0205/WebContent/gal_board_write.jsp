			...
			<div id="matList" >
				...
				<div class="container margin1 fontsize" id="formOutterWrapper">
					...
					<div class="container" id="formInnerWrapper">
						<form action="galWritePro.bo" method="post" enctype="multipart/form-data" name="boardform" role="form">
							...
							<div class="form-group">
								...
								<div class="col-xs-4 buttonmargin">
									...
									<input type="submit" value="등록" class="signbutton signbutton5 buttongal" style="font-size: 15px;"> <input type="button" value="취소" class="signbutton signbuttoncancel buttongal margin3" style="font-size: 15px; margin-top: 14px;" onClick="script: location.href='gal_board_list.jsp'">
								</div>
							</div>
