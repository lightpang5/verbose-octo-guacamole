...
<body>
	...
	<header>
		...
		<section id="main">
			...
			<h1 align=center>Q & A 게시글 수정</h1>
				<div id="matList">
					<div class="sec_ban2">
						<form action="updatejump2.jsp" style="margin-top:100px;">
 					<%
 					...
 					session.setAttribute("qTitle",qTitle);
 					session.setAttribute("qMember",qMember);
 					session.setAttribute("qContents",qContents);
 					 %>
					</div>
					<div class="cbox">
								...
								<tr>
									...
									<td>
										<div class="form-group has-success">
											<input type="text" value="<%out.println(qTitle); %>" class="form-control" id="qTitle_up" name="qTitle_up">
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="form-group has-success">
											<input type="text" value="<%out.println(qMember); %>" class="form-control" id="qMember_up" name="qMember_up" maxlength="10" style="width: 250px" >
										</div>
									</td>
								</tr>
								<tr>
									<td>내용</td>
									<td>
										<textarea class="form-control" rows="7" style="resize:none;" id="qContents_up" name="qContents_up">
										<%out.println(qContents); %>
										</textarea>
									</td>
								</tr>
							</tbody>
						...
						<input type=submit class="btn btn-default pull-right" id="update" name="update" value="수정하기" onclick="script: location.href='updatejump.jsp"/><br>
					</form> 
