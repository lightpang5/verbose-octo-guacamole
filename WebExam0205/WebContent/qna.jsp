						...
						<table class="table table-striped" id="qnaTopTable">
							<tbody>
									...
									<td>
										<div class="form-group has-success">
											<input type="text" class="form-control" id="qTitle"
												name="qTitle" style="width: 670px; margin-top: 7px;">
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="form-group has-success">
											<input type="text" class="form-control" id="qMember"
												name="qMember" maxlength="10"
										...
										<div class="form-group has-warning"
											...
											<div class="checkbox" style="height: 25px;">
												<label for="qSecret2"> <input type="radio"
													id="qSecret2" name="qSecret" value="pb">공개
												</label> <label for="qSecret"> <input type="radio"
													id="qSecret" name="qSecret" value="sc" checked>비밀글
													설정
												</label>
											</div>
											<input type="password" class="form-control" id="qSecretNum"
												name="qSecretNum" maxlength="10"
												style="width: 250px; margin-top: 7px;">
										</div>
									</td>
								</tr>
								<tr>
									...
									<td><textarea id="qContents" name="qContents"
						...
						<tbody>
							...
							<a>
								<tr>
									...
									<td class="thtitle"><a
										onClick="selectOne(<%=list.get(i).getqNo()%>); "
										class="button" id="listtt"><%=list.get(i).getqTitle()%></a> <%
 									if (list.get(i).getqSecret().equals("sc"))
							...
							<%
								...
								<a>
									<tr>
										<td class="thgongji" style="text-align: left;"><%=searchlist.get(i).getqNo()%></td>
										<td class="thtitle"><a
											onClick="selectOne(<%=searchlist.get(i).getqNo()%>); "
											class="button" id="listtt"><%=searchlist.get(i).getqTitle()%></a> <%
	 	if (searchlist.get(i).getqSecret().equals("sc"))
	 			out.print("<img src='img/lock2.png' class='secretimg' style='width: 15px; height: 15px;'>");
	 %></td>
										<td class="thname" name="thname" id="thname"><%=searchlist.get(i).getqMember()%></td>
										<td class="thdate"><%=searchlist.get(i).getqDate()%></td>
										<td class="thview"><%=searchlist.get(i).getqCount()%></td>
									</tr>
								</a>
								<%
									}
