...
<jsp:useBean id="yl" class="vo.YonglistDao" />
	<%
		...
		for(int i=0;i<yong.size();i++){
			if(id.equals(yong.get(i).getyId())){
		acc++;
			}
			...
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					...
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post" action="yongsignInsert.jsp?fn=2&yNo=<%=index%>" role="form" autocomplete="off">
							...
							<div class="form-group" style="height:130px;">
								...
								<div class="col-xs-4">
									...
									<textarea name="yContents" id="yContents" style="width:630px;resize:none; height:100px;" placeholder="메모를 입력하세요." ></textarea>
								</div>
								
							</div>
							
	
								<div class="col-xs-4" style="float:left;margin-left: 200px;">
						...
						<div class="col-xs-4" style="float: left; margin-left: 45px;">
...
<%}
	...
	if(acc>=1&&!id.equals("null")){
	acc=0;
	out.println("<script>alert('게시글이 삭제되었습니다.');location.href='yonglist_1.jsp';</script>");
	out.println(id+edit);
	yl.delete(index);
